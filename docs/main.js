...
function initMap() {
  ...
  const showMapLoadingToggle = document.getElementById('show-map-loading');
  if (showMapLoadingToggle) {
    showMapLoadingIndicator = !!showMapLoadingToggle.checked;
    showMapLoadingToggle.addEventListener('change', () => {
      showMapLoadingIndicator = !!showMapLoadingToggle.checked;
      if (!showMapLoadingIndicator) mapLoadingEl?.classList.add('hidden');
    });
  }
