...
copy_file "frontend/favicon-16x16.png" "docs/favicon-16x16.png"
copy_file "frontend/favicon-32x32.png" "docs/favicon-32x32.png"
copy_file "frontend/apple-touch-icon.png" "docs/apple-touch-icon.png"
copy_file "frontend/android-chrome-192x192.png" "docs/android-chrome-192x192.png"
copy_file "frontend/android-chrome-512x512.png" "docs/android-chrome-512x512.png"
copy_file "frontend/site.webmanifest" "docs/site.webmanifest"
